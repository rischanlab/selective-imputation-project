...
class SeeDB:
    ...
    def query(self):
        ...
        # else:
        query1 = 'select ' + self.attribute2 + ',' + self.func + '(' + self.attribute1 + ')' + ' from ' + self.table + ' where '  + self.table +  ' is not null '
        if self.where1 != '':
            query1 += ' and ' + self.where1
        ...
        # else:
        query2 = 'select ' + self.attribute2 +',' + self.func + '(' + self.attribute1 + ')' + ' from ' + self.table + ' where '  + self.table +  ' is not null '
        if self.where2 != '':
            query2 += ' and ' + self.where2
