...
input_file1 = 'results/drop_rows_missing_attributes_vs_ideal.csv'
input_file2 = 'results/ignore_cells_missing_attributes_vs_ideal.csv'
input_file3 = 'results/median_impute_missing_attributes_vs_ideal.csv'
input_file4 = 'results/mode_impute_missing_attributes_vs_ideal.csv'



output_plot = 'RBO_10_missing_attributes_vs_ideal'
...
ax.set_title("Impact of k on Effectiveness, 10 % missing on A")
ax.set_xlabel("k")
ax.set_ylabel("RBO- missingTopK to idealTopK")
