...
input_file1 = 'results/cum_missing_a_m_vs_ideal_drop_row.csv'
input_file2 = 'results/cum_missing_a_m_vs_ideal_ignore_missing_cells.csv'
input_file3 = 'results/cum_missing_a_m_vs_ideal_median.csv'
input_file4 = 'results/cum_missing_a_m_vs_ideal_mode.csv'


output_plot = 'Cum_10_missing_a_m_vs_ideal'
