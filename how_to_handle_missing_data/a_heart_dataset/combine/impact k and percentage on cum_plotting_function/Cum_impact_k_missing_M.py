...
input_file1 = 'results/cum_missing_measures_vs_ideal_drop_row.csv'
input_file2 = 'results/cum_missing_measures_vs_ideal_ignore_missing_cells.csv'
input_file3 = 'results/cum_missing_measures_vs_ideal_median.csv'
input_file4 = 'results/cum_missing_measures_vs_ideal_mode.csv'


output_plot = 'Cum_10_missing_measures_vs_ideal'

# ===============================================================
# IDEAL VS STANDARD

df1 = pd.read_csv(input_file1, names=['percentage','k','Cum'])
...
df2 = pd.read_csv(input_file2, names=['percentage','k','Cum'])
...
kj266 = df2[(df2['k'] == 50) & (df2['percentage'] == percent)]
kj266 = kj266['Cum']
...
df3 = pd.read_csv(input_file3, names=['percentage','k','Cum'])
...
kj350 = kj350['Cum']
kj360 = df3[(df3['k'] == 50) & (df3['percentage'] == percent)]
kj360 = kj360['Cum']
...
df4 = pd.read_csv(input_file4, names=['percentage','k','Cum'])
...
df4 = pd.DataFrame([kj45, kj410, kj413, kj420, kj450, kj460, kj466, kj4192])
...
ax.set_xlabel("k")
ax.set_ylabel("Cumulative dist - missingTopK to idealTopK")
