...
ideal_topk = ag.generate_kurtosis_insights_abs(db_ideal)
...
for k in k_list:
	...
	for i in mlist:
	    for j in range(100):
	    	...
	    	temp_topk = ag.generate_kurtosis_insights_abs(data)
	    	missing_topk = temp_topk[:k]
	    	with open('results/drop_missing_kurtosis_missing_vs_ideal_abs.csv', 'a', newline='') as f:
