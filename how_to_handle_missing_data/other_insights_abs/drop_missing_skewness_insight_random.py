...
ideal_topk = ag.generate_skewness_insights_abs(db_ideal)
#print(ideal_topk, len(ideal_topk))


k_list = [5,8,10,11,13]#5,10,15,20,25,30,35,40,45
...
for k in k_list:
	...
	for i in mlist:
	    for j in range(100):
	    	...
	    	temp_topk = ag.generate_skewness_insights_abs(data)
	    	missing_topk = temp_topk[:k]
	    	with open('results/drop_missing_skewness_missing_vs_ideal_abs.csv', 'a', newline='') as f:
