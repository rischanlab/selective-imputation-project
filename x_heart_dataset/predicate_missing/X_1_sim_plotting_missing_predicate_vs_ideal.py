...
output_plot = '10_sim_missing_predicate_vs_ideal'
...
k20j = df[(df['k'] == 30) & (df['percentage'] == percent)]
k20j = k20j['Jaccard']

k70j = df[(df['k'] == 40) & (df['percentage'] == percent)]
k70j = k70j['Jaccard']
...
k15r = k15r['RBO']
k20r = df[(df['k'] == 30) & (df['percentage'] == percent)]
k20r = k20r['RBO']

k70r = df[(df['k'] == 40) & (df['percentage'] == percent)]
k70r = k70r['RBO']
