...
input_file = 'results/sim_missing_predicate_vs_ideal.csv'

output_plot = 'sim_all_percentage_missing_predicate_vs_ideal'
...
# dfj90 = df[(df['k'] == 5) & (df['percentage'] == 90)]
# dfj90 = dfj90['Jaccard']
...
# dfr90 = df[(df['k'] == 5) & (df['percentage'] == 90)]
# dfr90 = dfr90['RBO']
...
df = pd.DataFrame([dfj00, dfj10, dfj20, dfj30, dfj40, dfj50, dfj60, dfj70, dfj80,
                   dfr00, dfr10, dfr20, dfr30, dfr40, dfr50, dfr60, dfr70, dfr80])
