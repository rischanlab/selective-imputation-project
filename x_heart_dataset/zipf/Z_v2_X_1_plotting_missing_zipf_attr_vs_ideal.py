...
output_plot = 'missing_zipf_attributes_vs_ideal'

# ===============================================================
# IDEAL VS STANDARD

df = pd.read_csv(input_file, names=['a','k','RBO','Jaccard'])

alpha =  1.4 #1.01
#[5, 10, 15, 20, 100, 192]
k5j = df[(df['k'] == 5) & (df['a'] == alpha)]
k5j = k5j['Jaccard']
k10j = df[(df['k'] == 10) & (df['a'] == alpha)]
k10j = k10j['Jaccard']
k15j = df[(df['k'] == 15) & (df['a'] == alpha)]
k15j = k15j['Jaccard']
k20j = df[(df['k'] == 20) & (df['a'] == alpha)]
k20j = k20j['Jaccard']

k100j = df[(df['k'] == 100) & (df['a'] == alpha)]
k100j = k100j['Jaccard']
k192j = df[(df['k'] == 192) & (df['a'] == alpha)]
k192j = k192j['Jaccard']

#RBO
k5r = df[(df['k'] == 5) & (df['a'] == alpha)]
k5r = k5r['RBO']
k10r = df[(df['k'] == 10) & (df['a'] == alpha)]
k10r = k10r['RBO']
k15r = df[(df['k'] == 15) & (df['a'] == alpha)]
k15r = k15r['RBO']
k20r = df[(df['k'] == 20) & (df['a'] == alpha)]
k20r = k20r['RBO']

k100r = df[(df['k'] == 100) & (df['a'] == alpha)]
k100r = k100r['RBO']
k192r = df[(df['k'] == 192) & (df['a'] == alpha)]
k192r = k192r['RBO']
...
ax.set_title(r'Impact of k on Effectiveness, Zipf A missing $\alpha = 1.4$')
ax.set_xlabel("k")
