...
input_file = 'results/sim_missing_attributes_vs_ideal.csv'

output_plot = 'sim_all_percentage_missing_attributes_vs_ideal'
...
dfr00 = df[(df['k'] == k) & (df['percentage'] == 0)]
dfr00 = dfr00['RBO']

dfr10 = df[(df['k'] == k) & (df['percentage'] == 10)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == k) & (df['percentage'] == 20)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == k) & (df['percentage'] == 30)]
dfr30 = dfr30['RBO']

# dfr40 = df[(df['k'] == k) & (df['percentage'] == 40)]
# dfr40 = dfr40['RBO']

# dfr50 = df[(df['k'] == k) & (df['percentage'] == 50)]
# dfr50 = dfr50['RBO']

# dfr60 = df[(df['k'] == k) & (df['percentage'] == 60)]
# dfr60 = dfr60['RBO']

# dfr70 = df[(df['k'] == k) & (df['percentage'] == 70)]
# dfr70 = dfr70['RBO']

# dfr80 = df[(df['k'] == k) & (df['percentage'] == 80)]
# dfr80 = dfr80['RBO']
...
ax.set_ylabel("Effectiveness similarity - Missing A")
x = [0, 10, 20, 30]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
