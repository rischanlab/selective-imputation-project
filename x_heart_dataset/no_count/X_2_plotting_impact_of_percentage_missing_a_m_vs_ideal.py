...
output_plot = 'all_percentage_missing_a_m_vs_ideal'
...
ax.set_title("Impact of percentage of missing on Effectiveness, 95% CI, k = 10")
ax.set_xlabel("percentage of missing")
ax.set_ylabel("Effectiveness - Missing A and M to Ideal")
x = [0, 10, 20, 30]
xi = list(range(len(x)))
plt.xticks(xi, x)
# Display legend
