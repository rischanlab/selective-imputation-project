...
if __name__ == "__main__":
    ...
    for k in k_list:
        ...
        topk = ag.get_sim_topk_aggregate(k, file_ideal_topk)
        ...
        for percent in percentage_list:
            for i in range(100):
                ...
                for file_view in glob.glob(file_name):
                    ...
                    missing = ag.get_sim_topk_aggregate(k, file_view)
                    ...
                    with open('new_results/sim_missing_attributes_vs_ideal.csv', 'a', newline='') as f:
