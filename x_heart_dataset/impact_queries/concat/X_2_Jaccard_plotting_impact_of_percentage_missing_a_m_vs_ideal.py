...
input_file1 = 'results/disease_missing_a_m_vs_ideal.csv'
input_file2 = 'results/cp_missing_a_m_vs_ideal.csv'
input_file3 = 'results/sex_missing_a_m_vs_ideal.csv'
input_file4 = 'results/exang_missing_a_m_vs_ideal.csv'
...
ax.set_title("Impact missing on Effectiveness, k = 5")
