...
input_file1 = 'results/gap_disease_a_m.csv'
input_file2 = 'results/gap_cp_a_m.csv'
input_file3 = 'results/gap_sex_a_m.csv'
input_file4 = 'results/gap_exang_a_m.csv'
...
plt.title('Impact of different input queries on effectiveness')
q1 = mpatches.Patch(color='#539caf', label='q1: disease = Yes vs No')
q2 = mpatches.Patch(color='#b65332', label='q2: cp = typical_angina vs No')
q3 = mpatches.Patch(color='#5be19a', label='q3: sex = Female vs Male')
q4 = mpatches.Patch(color='#ece554', label='q4: exang = exercise induced angina vs No')
