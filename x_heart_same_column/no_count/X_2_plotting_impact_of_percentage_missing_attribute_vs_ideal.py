...
output_plot = 'all_percentage_missing_attributes_vs_ideal'
...
dfj00 = df[(df['k'] == 10) & (df['percentage'] == 0)]
dfj00 = dfj00['Jaccard']

dfj10 = df[(df['k'] == 10) & (df['percentage'] == 10)]
dfj10 = dfj10['Jaccard']

dfj20 = df[(df['k'] == 10) & (df['percentage'] == 20)]
dfj20 = dfj20['Jaccard']

dfj30 = df[(df['k'] == 10) & (df['percentage'] == 30)]
dfj30 = dfj30['Jaccard']

dfj40 = df[(df['k'] == 10) & (df['percentage'] == 40)]
dfj40 = dfj40['Jaccard']

# dfj50 = df[(df['k'] == 10) & (df['percentage'] == 50)]
# dfj50 = dfj50['Jaccard']

# dfj60 = df[(df['k'] == 10) & (df['percentage'] == 60)]
# dfj60 = dfj60['Jaccard']

# dfj70 = df[(df['k'] == 10) & (df['percentage'] == 70)]
# dfj70 = dfj70['Jaccard']

# dfj80 = df[(df['k'] == 10) & (df['percentage'] == 80)]
# dfj80 = dfj80['Jaccard']
...
dfr00 = df[(df['k'] == 10) & (df['percentage'] == 0)]
dfr00 = dfr00['RBO']

dfr10 = df[(df['k'] == 10) & (df['percentage'] == 10)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == 10) & (df['percentage'] == 20)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == 10) & (df['percentage'] == 30)]
dfr30 = dfr30['RBO']

dfr40 = df[(df['k'] == 10) & (df['percentage'] == 40)]
dfr40 = dfr40['RBO']

# dfr50 = df[(df['k'] == 10) & (df['percentage'] == 50)]
# dfr50 = dfr50['RBO']

# dfr60 = df[(df['k'] == 10) & (df['percentage'] == 60)]
# dfr60 = dfr60['RBO']

# dfr70 = df[(df['k'] == 10) & (df['percentage'] == 70)]
# dfr70 = dfr70['RBO']

# dfr80 = df[(df['k'] == 10) & (df['percentage'] == 80)]
# dfr80 = dfr80['RBO']
...
df = pd.DataFrame([dfj00, dfj10, dfj20, dfj30, dfj40,
                   dfr00, dfr10, dfr20, dfr30, dfr40])
...
ax.set_title("Impact of missing on Effectiveness, 95% CI, k = 10")
