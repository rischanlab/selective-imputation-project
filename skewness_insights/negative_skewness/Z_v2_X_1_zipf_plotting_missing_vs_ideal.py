...
output_plot = 'v2_skewness_zipf_missing_vs_ideal'
...
k3j = df[(df['k'] == 3) & (df['alpha'] == alpha)]
k3j = k3j['Jaccard']

k5j = df[(df['k'] == 5) & (df['alpha'] == alpha)]
k5j = k5j['Jaccard']

k8j = df[(df['k'] == 8) & (df['alpha'] == alpha)]
k8j = k8j['Jaccard']
...
k3r = df[(df['k'] == 3) & (df['alpha'] == alpha)]
k3r = k3r['RBO']

k5r = df[(df['k'] == 5) & (df['alpha'] == alpha)]
k5r = k5r['RBO']

k8r = df[(df['k'] == 8) & (df['alpha'] == alpha)]
k8r = k8r['RBO']
