...
input_file = 'results/missing_vs_ideal_random.csv'

output_plot = '50_skewness_missing_vs_ideal'
...
k3j = df[(df['k'] == 3) & (df['percentage'] == percent)]
k3j = k3j['Jaccard']

k5j = df[(df['k'] == 5) & (df['percentage'] == percent)]
k5j = k5j['Jaccard']

k8j = df[(df['k'] == 8) & (df['percentage'] == percent)]
k8j = k8j['Jaccard']
...
k3r = df[(df['k'] == 3) & (df['percentage'] == percent)]
k3r = k3r['RBO']

k5r = df[(df['k'] == 5) & (df['percentage'] == percent)]
k5r = k5r['RBO']

k8r = df[(df['k'] == 8) & (df['percentage'] == percent)]
k8r = k8r['RBO']
