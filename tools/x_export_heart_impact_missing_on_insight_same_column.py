...
table_name = 'heart'
connection = pg.connect("dbname=aheart_dataset_random_same_column user=postgres password=zenvisage")
...
size = 3887
engine = create_engine(r'postgresql+psycopg2://postgres:zenvisage@localhost:5432/aheart_dataset_random_same_column')
