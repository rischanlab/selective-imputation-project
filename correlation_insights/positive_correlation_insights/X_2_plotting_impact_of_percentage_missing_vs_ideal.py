...
input_file = 'results/missing_vs_ideal.csv'

output_plot = 'correlation_all_percentage_missing_vs_ideal'
...
dfr90 = df[(df['k'] == k) & (df['percentage'] == 90)]
dfr90 = dfr90['RBO']
...
df = pd.DataFrame([dfj00, dfj10, dfj20, dfj30, dfj40, dfj50, dfj60, dfj70, dfj80, dfj90,
                   dfr00, dfr10, dfr20, dfr30, dfr40, dfr50, dfr60, dfr70, dfr80, dfr90])
