...
output_plot = 'v2_all_alpha_measures_vs_ideal'
...
dfj00 = df[(df['k'] == k) & (df['alpha'] == 1.1)]
dfj00 = dfj00['Jaccard']

dfj10 = df[(df['k'] == k) & (df['alpha'] == 1.2)]
dfj10 = dfj10['Jaccard']

dfj20 = df[(df['k'] == k) & (df['alpha'] == 1.3)]
dfj20 = dfj20['Jaccard']

dfj30 = df[(df['k'] == k) & (df['alpha'] == 1.4)]
dfj30 = dfj30['Jaccard']

dfj40 = df[(df['k'] == k) & (df['alpha'] == 1.5)]
dfj40 = dfj40['Jaccard']

dfj50 = df[(df['k'] == k) & (df['alpha'] == 1.6)]
dfj50 = dfj50['Jaccard']

dfj60 = df[(df['k'] == k) & (df['alpha'] == 1.7)]
dfj60 = dfj60['Jaccard']
...
dfr00 = df[(df['k'] == k) & (df['alpha'] == 1.1)]
dfr00 = dfr00['RBO']

dfr10 = df[(df['k'] == k) & (df['alpha'] == 1.2)]
dfr10 = dfr10['RBO']

dfr20 = df[(df['k'] == k) & (df['alpha'] == 1.3)]
dfr20 = dfr20['RBO']

dfr30 = df[(df['k'] == k) & (df['alpha'] == 1.4)]
dfr30 = dfr30['RBO']

dfr40 = df[(df['k'] == k) & (df['alpha'] == 1.5)]
dfr40 = dfr40['RBO']

dfr50 = df[(df['k'] == k) & (df['alpha'] == 1.6)]
dfr50 = dfr50['RBO']

dfr60 = df[(df['k'] == k) & (df['alpha'] == 1.7)]
dfr60 = dfr60['RBO']
