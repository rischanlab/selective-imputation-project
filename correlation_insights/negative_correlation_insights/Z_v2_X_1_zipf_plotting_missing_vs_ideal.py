...
input_file = 'results/v2_missing_vs_ideal_zipf.csv'

output_plot = 'v2_correlation_zipf_missing_vs_ideal'

# ===============================================================
# IDEAL VS STANDARD

df = pd.read_csv(input_file, names=['alpha','k','RBO','Jaccard'])

alpha = 1.4
#[5, 10, 15, 20, 30, 45]
k5j = df[(df['k'] == 5) & (df['alpha'] == alpha)]
k5j = k5j['Jaccard']
k10j = df[(df['k'] == 10) & (df['alpha'] == alpha)]
k10j = k10j['Jaccard']
k15j = df[(df['k'] == 15) & (df['alpha'] == alpha)]
k15j = k15j['Jaccard']

k20j = df[(df['k'] == 20) & (df['alpha'] == alpha)]
k20j = k20j['Jaccard']

k25j = df[(df['k'] == 25) & (df['alpha'] == alpha)]
k25j = k25j['Jaccard']

k30j = df[(df['k'] == 30) & (df['alpha'] == alpha)]
k30j = k30j['Jaccard']

k35j = df[(df['k'] == 35) & (df['alpha'] == alpha)]
k35j = k35j['Jaccard']

k40j = df[(df['k'] == 40) & (df['alpha'] == alpha)]
k40j = k40j['Jaccard']

k45j = df[(df['k'] == 45) & (df['alpha'] == alpha)]
k45j = k45j['Jaccard']

#RBO
k5r = df[(df['k'] == 5) & (df['alpha'] == alpha)]
k5r = k5r['RBO']
k10r = df[(df['k'] == 10) & (df['alpha'] == alpha)]
k10r = k10r['RBO']
k15r = df[(df['k'] == 15) & (df['alpha'] == alpha)]
k15r = k15r['RBO']
k20r = df[(df['k'] == 20) & (df['alpha'] == alpha)]
k20r = k20r['RBO']

k25r = df[(df['k'] == 25) & (df['alpha'] == alpha)]
k25r = k25r['RBO']

k30r = df[(df['k'] == 30) & (df['alpha'] == alpha)]
k30r = k30r['RBO']

k35r = df[(df['k'] == 35) & (df['alpha'] == alpha)]
k35r = k35r['RBO']

k40r = df[(df['k'] == 40) & (df['alpha'] == alpha)]
k40r = k40r['RBO']

k45r = df[(df['k'] == 45) & (df['alpha'] == alpha)]
k45r = k45r['RBO']
...
ax.set_title(r'Impact of k on Effectiveness, Zipf missing $\alpha = 1.4$')
ax.set_xlabel("k")
